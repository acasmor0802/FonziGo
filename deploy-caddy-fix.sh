#!/bin/bash
# ==============================================================================
# FonziGo - Deployment Script (con navegación automática al proyecto)
# ==============================================================================
...
# Función para encontrar y navegar al directorio del proyecto
find_and_cd_project() {
...
if [ -d ".git" ]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "⚠️  Error al obtener cambios"
    fi
else
    echo "⚠️  No es un repositorio git, continuando..."
fi
